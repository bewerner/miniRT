...
SRC					=	main.c cleanup.c parser.c hooks.c movement.c render.c plane.c cylinder.c sphere.c vec3_utils1.c vec3_utils2.c vec4_utils1.c vec3_rotate.c color_convert.c time.c
